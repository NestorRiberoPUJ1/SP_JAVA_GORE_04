...
public class Movie {
    ...
    @Size(min = 4, max = 100, message = "El titulo debe contener entre 4 y 100 caracteres") // Indica el tamaño mínimo y
                                                                                            // máximo del atributo
    ...
    @Size(min = 4, max = 48, message = "El genero debe ser entre 4 y 48 caracteres") // Indica el tamaño mínimo y máximo
                                                                                     // del atributo
    private String gender;

    @NotNull(message = "La sinopsis no puede ser nula") // Indica que el atributo no puede ser nulo
    @Size(min = 30, max = 500, message = "La sinopsis no debe ser menor a 30 ni mayor a 500 caracteres") // Indica el
                                                                                                         // tamaño
                                                                                                         // mínimo y
                                                                                                         // máximo del
                                                                                                         // atributo
